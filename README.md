...
* [ ] User can **tap a todo item in the list and bring up an edit screen(Dialog Fragment) for the todo item** and then have any changes to the text reflected in the todo list.
...
<img src='https://i.imgur.com/bX1AnVF.gif' title='ToDo App Video Walkthrough' width='600' alt='Video Walkthrough' />
